...
## Context
The existing patron creation flow allowed users to select a preferred library branch only from a static dropdown (`BranchesDropdown`). This approach had several limitations:
