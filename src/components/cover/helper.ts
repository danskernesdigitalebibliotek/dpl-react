...
if (import.meta.vitest) {
  ...
  const coverImageUrls = {
    xSmall: "https://fbiinfo-present.dbc.dk/images/xsmall-url.jpg",
    small: "https://fbiinfo-present.dbc.dk/images/small-url.jpg",
    medium: "https://fbiinfo-present.dbc.dk/images/medium-url.jpg",
    large: "https://fbiinfo-present.dbc.dk/images/large-url.jpg"
  };
  ...
  describe("getCoverUrl – resolves cover image URLs with fallback logic", () => {
    ...
    it("falls back from medium → xSmall if large/small are invalid", () => {
      const cover: Cover = {
        ...baseCoverData,
        medium: {
          __typename: "CoverDetails" as const,
          url: "",
          width: 0,
          height: 0
        },
    ...
    it("returns valid URL even if width/height are missing", () => {
      const cover: Cover = {
        ...
        small: {
          __typename: "CoverDetails" as const,
          url: "https://fbiinfo-present.dbc.dk/images/small-url.jpg"
        }
      };
