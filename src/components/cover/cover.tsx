...
export const Cover = ({
  ...
  const layoutSize = getCoverDisplaySize({ displaySize, size });
  const dataSize = displaySizeToGraphQLKey[layoutSize];
  ...
  const classes = {
    wrapper: clsx(
      "cover",
      `cover--size-${layoutSize}`,
      `cover--aspect-${layoutSize}`,
