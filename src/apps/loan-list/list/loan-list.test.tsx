...
describe("Loan list", () => {
  ...
  it("It opens material details modal", () => {
    ...
    cy.get(".modal-details__container").should(
      "have.text",
      "Dummy bogOverskredetDummy Some TitleAf Dummy Jens Jensen og Dummy Some Corporationforny dit lånAfleveringsdatoen for lånet er overskredet, derfor pålægges du et gebyr, når materialet afleveres Læs mereAfleveres10-07-2022Udlånsdato10-06-2022Materialenummer3846990827"
    );
  });
});
