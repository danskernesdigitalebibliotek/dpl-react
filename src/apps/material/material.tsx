...
const Material: React.FC<MaterialProps> = ({ wid }) => {
  ...
  // periodikumSelect must be used later to change the UI and reservation when you have chosen a specific periodical
  // eslint-disable-next-line
  const [periodikumSelect, setPriodikumSelect] = useState<string | null>(null);
