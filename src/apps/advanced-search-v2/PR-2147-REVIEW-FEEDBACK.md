...
- **Issue:** Raw `<button>` element instead of the shared `Button` component
- **Fix:** Use existing `Button` component for consistency
- **Status:** ⬜ Not started

### 5. Remove unnecessary `shallow: true`
...
### 6. Move t() call into operatorMap
...
### 7. Add console logging for missing config
...
### 8. Add comment explaining focus index calculation
...
### 9. Add comment explaining history: "push"
...
### 10. Move operators to shared constant
...
### 11. Remove unused traceId from GraphQL query
...
### 14. Use span instead of p inside button
...
### 15. Improve aria-expanded accessibility
...
### 16. Consider using usePrevious() hook
...
### 17. Review hook return properties
...
### 18. Consider keepPreviousData from React Query
...
### 19. Accessibility: link count to checkbox label
