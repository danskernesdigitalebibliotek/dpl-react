 ...
 */
export type DplOpeningHoursListGET200ItemRepetitionType =
  (typeof DplOpeningHoursListGET200ItemRepetitionType)[keyof typeof DplOpeningHoursListGET200ItemRepetitionType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DplOpeningHoursListGET200ItemRepetitionType = {
  none: "none",
  weekly: "weekly"
} as const;
